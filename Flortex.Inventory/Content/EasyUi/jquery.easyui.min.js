...
(function ($) {
    ...
    function _116(_11c, _11d, flag) {
        ...
        // start by Pasha
        if (_11d.checkState === "unchecked") {
            if (_11d.value != undefined) {
                _11d.value = false;
            }

            if (_11d.indeterminate == null || _11d.indeterminate != undefined) {
                _11d.indeterminate = false;
            }
        }
        else if (_11d.checkState === "checked" ) {
            if (_11d.value != undefined) {
                _11d.value = true;
            }
        }
        else if (_11d.checkState === "indeterminate") {
            if (_11d.value != undefined) {
                _11d.value = true;
            }

            if (_11d.indeterminate==null || _11d.indeterminate != undefined) {
                _11d.indeterminate = true;
            }
        }
        // end by Pasha
...
(function ($) {
    ...
    $.fn.panel.defaults = {
        id: null, title: null, iconCls: null, width: "auto", height: "auto", left: null, top: null, cls: null, headerCls: null, bodyCls: null, style: {}, href: null, cache: true, fit: false, border: true, doSize: true, noheader: false, content: null, halign: "top", titleDirection: "down", collapsible: false, minimizable: false, maximizable: false, closable: false, collapsed: false, minimized: false, maximized: false, closed: false, openAnimation: false, openDuration: 400, closeAnimation: false, closeDuration: 400, tools: null, footer: null, header: null, queryParams: {}, method: "get", href: null, loadingMessage: "Loading...", loader: function (_274, _275, _276) {
            ...
            $.ajax({
                type: opts.method, url: opts.href, cache: false, data: _274, dataType: "html", success: function (data) {
                    _275(data);
                }, error: function () {
...
(function ($) {
    ...
    function _297(_298) {
        ...
        _299.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _299.options.draggable == false, onBeforeDrag: function (e) {
                if (_299.mask) {
...
(function ($) {
    ...
    $.messager = {
        show: function (_2c8) {
            ...
            var dlg = _2c5($.extend({}, $.messager.defaults, { content: "<div class=\"messager-progress\"><div class=\"messager-p-msg\">" + opts.msg + "</div><div class=\"messager-p-bar\"></div></div>", closable: false, doSize: false }, opts, {
                onClose: function () {
                    if (this.timer) {
...
(function ($) {
    ...
    function _2f2(_2f3, pp, _2f4) {
        ...
        pp.panel($.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body", halign: opts.halign }, _2f4, {
            onBeforeExpand: function () {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, halign: "top", onSelect: function (_320, _321) {
...
(function ($) {
    ...
    function _358(_359, _35a, pp) {
        ...
        pp.panel($.extend({}, _35a, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_35a.icon ? _35a.icon : undefined), onLoad: function () {
                if (_35a.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_3a1) {
...
(function ($) {
    ...
    function _3dd(_3de, _3df, _3e0) {
        ...
        function _3e4(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                cls: ("layout-expand layout-expand-" + dir), title: "&nbsp;", titleDirection: _3e2.titleDirection, iconCls: (_3e2.hideCollapsedContent ? null : _3e2.iconCls), closed: true, minWidth: 0, minHeight: 0, doSize: false, region: _3e2.region, collapsedSize: _3e2.collapsedSize, noheader: (!isns && _3e2.hideExpandTool), tools: ((isns && _3e2.hideExpandTool) ? null : [{
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapsedSize: 28, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_416) {
            var p = $(this);
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 120, itemHeight: 22, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _431, mouseleave: _434, mouseover: _438, mouseout: _43b, click: _43d }, position: function (_46d, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 26, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", onChange: function (_4b6) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: { focus: _557, blur: _55b }, val: function (_564) {
...
(function ($) {
    ...
    function _68e(_68f) {
        ...
        if (opts.pagination) {
            ...
            _696.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_697, _698) {
    ...
    function _6a5(_6a6) {
        ...
        _6ab.each(function () {
            $(this).resizable({
                handles: _6ac, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _6a7.resizing = true;
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", resizeEdge: 5, autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 24, headerEvents: { mouseover: _6af(true), mouseout: _6af(false), click: _6b3, dblclick: _6b8, contextmenu: _6bb }, rowEvents: { mouseover: _6bd(true), mouseout: _6bd(false), click: _6c4, dblclick: _6ce, contextmenu: _6d2 }, rowStyler: function (_86d, _86e) {
            ...
            //@@To Do for rest of the list views




            // This is specific to products list veiw that would be displayed in the slik grid (document body fields)
            // This would be called for the very first time when the data has to be populated in the edit mode
            if (opts.isProductsBodyListView) {

                if (!_.has(_86f, "wareHouseId")) {
                    _86f["wareHouseId"] = opts.wareHouseId;
                };

                if (!_.has(_86f, "q")) {
                    _86f["q"] = opts.defaultSearch;
                    _86f["searchField"] = opts.searchField
                };
            }
...
(function ($) {
    ...
    function _8a9(_8aa) {
        ...
        $(_8aa).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_8ac, row) {
...
(function ($) {
    function _8f6(_8f7) {
        ...
        if (opts.pagination) {
            ...
            _903.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_904, _905) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _99b, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _911(true), mouseout: _911(false), click: _913 }), loader: function (_9d9, _9da, _9db) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
...
(function ($) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _9eb, textFormatter: function (_a07, row) {
            return _a07;
        ...
        switch (e.keyCode) {
            ...
            default:
                if (e.ctrlKey && e.keyCode > 48 && e.keyCode <= 57) {
                    ...
                    t.combo("showPanel");
                    opts.keyHandler.customSearch.call(_a20, q, e);
                }
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_aa6) {
            return _aa6;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, view: _aa1, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
...
(function ($) {
    ...
    // Added by Pasha
    function _p494(_b12, q, e) {

        var _b13 = $.data(_b12, "combogrid");
        var opts = _b13.options;
        var grid = _b13.grid;
        opts.searchField = opts.columns[0][e.keyCode - 49].field;
        customSearchHeaderCol(grid, opts);
        if (q)
            _b11(_b12, q, e);
    }

    function customSearchHeaderCol(grid, opts) {
        if (grid && opts) {
            var _searchField = opts.searchField ? opts.searchField : opts.textField;
            grid.datagrid('getPanel').find('div.datagrid-header td').removeClass('customSearch');
            grid.datagrid('getPanel').find('div.datagrid-header td[field=' + _searchField + ']').addClass('customSearch');
        }
    }
    function _b11(_b12, q, e) {
        var _b13 = $.data(_b12, "combogrid");
        var opts = _b13.options;
        var grid = _b13.grid;
        ...
        if (opts.mode == "remote") {
            _b14(qq);
            customSearchHeaderCol(grid, opts);
            // this feature is only for product listview which should be populated in slick grid (document body)
            if (opts.isProductsBodyListView) {
                grid.datagrid("load", $.extend({}, opts.queryParams, { wareHouseId: opts.wareHouseId, searchField: opts.searchField, q: q }));
            }
            else {
                grid.datagrid("load", $.extend({}, opts.queryParams, { searchField: opts.searchField, q: q }));
            }
    ...
    // searchField: null, isProductsBodyListView: false ==> Added by Pasha
    $.fn.combogrid.defaults = $.extend({}, $.fn.combo.defaults, $.fn.datagrid.defaults, {
        loadMsg: null, idField: null, textField: null, searchField: null, isProductsBodyListView: false, unselectedValues: [], mappingRows: [], mode: "local", keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
...
(function ($) {
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_b7c) {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_c0b) {
            return _c0b;
        }, converter: {
