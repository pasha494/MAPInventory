...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        function init() {
            ...
            $headerRowScroller = $("<div class='slick-headerrow ui-state-default' style='overflow:auto;position:relative;' />").appendTo($container);
        ...
        function getViewportHeight() {
            ...
            return parseFloat($.css($container[0], "height", true)) -
                ...
                (options.showHeaderRow ? options.headerRowHeight + 20 + getVBoxDelta($headerRowScroller) : 0);
        }
